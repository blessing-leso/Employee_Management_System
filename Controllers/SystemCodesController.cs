...
namespace EmployeeSystem.Controllers
{
    public class SystemCodesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Description,CreateById,CreateDate,ModifiedBy,ModifiedOn")] SystemCode systemCode)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Description,CreateById,CreateDate,ModifiedBy,ModifiedOn")] SystemCode systemCode)
        {
            if (id != systemCode.Id)
            {
                return NotFound();
