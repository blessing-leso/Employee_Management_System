...
namespace EmployeeSystem.Controllers
{
    public class SystemCodeDetailsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SystemCodeId,Code,Description,OrderNo,CreateById,CreateDate,ModifiedBy,ModifiedOn")] SystemCodeDetail systemCodeDetail)
        {
